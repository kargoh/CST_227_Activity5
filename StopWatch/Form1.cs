...
namespace StopWatch
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            pic_falseTarget.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red_x.png");
            pic_falseTarget1.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red_x.png");
            pic_falseTarget2.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red_x.png");
            pic_falseTarget3.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red_x.png");
            pic_target.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red_x.png");
        }
        ...
        private void gameRunning()
        {
            ...
            if (watch.IsRunning)
            {
                ...
                btn_missClick.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\purple-background.png");
            ...
            if (watch.IsRunning && hits >= 10)
            {
                ...
                btn_missClick.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\purple-blue-background.png");
            }
            ...
            if (watch.IsRunning && hits >= 20)
            {
                ...
                btn_missClick.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\pink-background.png");
            }
            ...
            if (watch.IsRunning && hits >= 30)
            {
                ...
                btn_missClick.BackgroundImage = new Bitmap(@"C:\Users\deben\Desktop\School Workspace\CST-227\Activity 5\Pictures\red-background.png");
            }
